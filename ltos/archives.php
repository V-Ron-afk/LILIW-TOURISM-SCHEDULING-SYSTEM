...
?>
    ...
    <body>
        <div class="container-fluid position-relative d-flex p-0">
            ...
            INNER JOIN users ON schedule.username = users.username where status = 'archive'";
                ...
                ?>
                    ...
                    <td>
                        <a class="btn btn-outline-success" href="undo.php?id=<?php echo $id; ?>"><i class="fa fa-undo"></i></a>
                    </td>

                    <td>
                        <a class="btn btn-outline-danger" id="#del" href="deletearc.php?id=<?php echo $id; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    </td>
                    </tr>
                    </tbody>
                ...
                <script>
                    $('#del').click(function() {
                        ...
                        window.setTimeout(function() {
                            window.location.replace('archives.php');
                        }, 1500);
                    });
                </script>
