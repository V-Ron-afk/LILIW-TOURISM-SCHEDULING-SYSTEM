                ...
                <nav class="navbar ">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <a href="chat.php?id=1" class="nav-item nav-link"><i class="fa fa-envelope me-2"></i>Chat</a>
                    ...
                    <div class="row">
                        <section class="discussions col-md-6">
                            ...
                            ?>
                                ...
                                <a href="chatstaff.php?id=<?php echo $row['user_id']; ?>" class="list-group-item list-group-item-action border-0">

                                    <div class="d-flex align-items-start">
                                        <img src="../pics/<?php echo $row['valid_id']; ?>" class="rounded-circle mr-1" onerror="this.onerror=null;this.src='https://placeimg.com/200/300/animals';" alt="Vanessa Tucker" width="40" height="40">
