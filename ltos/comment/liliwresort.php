                ...
                <div class="p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-row muted-color"> <span>
                                <?php
                                $sql = "SELECT * FROM gallery where gallery_id = 'resort'";
                    ...
                    <div class="comments">
                        ...
                        $sqlget51 = "SELECT * FROM gallery where gallery_id = 'resort'";
                        ...
                        ?>
                            ...
                            <form action="comment.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="pic" value="resort">
                                <div class="comment-input"> <input type="text" name="comment" class="form-control">
                                    <div class="fonts"> <label for=""><i class="far fa-paper-plane p-2"></i> </a></label></div>
                                </div>
                            </form>
                    </div>
                </div>
