    ...
    <div class="container mt-5 mb-5">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-md-6">
                ...
                </div> <img src="../images/resort/SIESTA.jpg" class="img-fluid" style=" width: 750px;">
                ...
                <div class="p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-row muted-color"> <span>
                                <?php
                                $sql = "SELECT * FROM gallery where gallery_id = 'SIESTA'";
                    ...
                    <div class="comments">
                        ...
                        $sqlget51 = "SELECT * FROM gallery where gallery_id = 'SIESTA'";
                        ...
                        ?>
                            ...
                            <form action="comment.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="pic" value="siesta">
