    ...
    <body>
        <div class="container-fluid position-relative d-flex p-0">
            ...
            <div class="content">
                ...
                ?>
                    <td>
                        <a class="btn btn-outline-danger" href="deletegal.php?id=<?php echo $id; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    </td>
