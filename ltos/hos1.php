    ...
    <div class="container-fluid position-relative d-flex p-0">
         ...
         <div class="sidebar pe-4 pb-3">
            <nav class="navbar ">
                ...
                <a href="staffpage.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    ...
                    <a href="hos1.php" class="nav-item nav-link"><i class="fa fa-address-book me-2"></i>History schedule</a>
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="userprofile.php" onClick="return confirm('User Personal Information!!!');" class="dropdown-item" style=" width:100px;">Profile</a>
                            <a href="logout.php" onClick="return confirm('Are you sure you want to logout?');" class="dropdown-item">Log Out</a> 
                            <!-- para ma kill ang session at di na makapasok ang di na ka login niloloko mo pa ko nakaka pasok ang di naka login sa inyo -->
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <?php 
                ...
                if (isset($_GET['save'])) {
                    $b_id = $_GET['save'];
                    $record = mysqli_query($con, "SELECT * FROM archives
                        INNER JOIN users ON archives.username = users.username
                        WHERE username=$b_id"); // eto example ng pag join ng dalawang table, yung table na books may column na cat_id yung table na categories may column na cat_id check mo db ulit
                ...
                echo "<thead><tr><th> Archives ID</th>";
                echo "
                        <th> Full Name</th>
                        <th> Email</th>
                        <th> contact</th>
                    ...
                    echo "</td>";
                    echo "<td>";
                    echo $fetch['departure'];
                    echo "</td>";

                ?>

                <td>
                    <a class="btn btn-outline-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                </td>
                </tr></tbody>
