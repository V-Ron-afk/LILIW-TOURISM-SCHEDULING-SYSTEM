...
?>
    ...
    <body>
        <div class="container-fluid position-relative d-flex p-0">
            ...
            INNER JOIN users ON schedule.username = users.username where status = ''";
                ...
                ?>
                    ...
                    <td>
                        <a class="btn btn-outline-success" href="smsapproved.php?id=<?php echo $id; ?>&phone=<?php echo $row['contact']; ?>&name=<?php echo $row['fullname']; ?>"><i class="fas fa-check"></i></a>
                    </td>

                    <td>
                        <a class="btn btn-outline-danger" href="sms.php?id=<?php echo $id; ?>&phone=<?php echo $row['contact']; ?>&name=<?php echo $row['fullname']; ?>"><i class="fa fa-window-close" aria-hidden="true"></i></a>
                    </td>
                    </tr>
                    </tbody>
