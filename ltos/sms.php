...
try{
	...
	$device = 192; 
	$sim = 1; // anong sim gamit mo pang send
	$message = "Hello, ".$_GET['name']." your Schedule has been rejected! Sorry for the inconvenience.";
	$number = $_GET['phone'];
...
$sql = "UPDATE `schedule` SET `status` = 'archive' WHERE `schedule`.`sched_id` = $id;";
