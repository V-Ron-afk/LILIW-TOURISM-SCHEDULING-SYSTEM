        ...
        <div class="sidebar pe-4 pb-3">
            ...
            //eto o kinuha ko sa session para makuha ko kung sino naka login
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="chatstaff.php?id=1" class="nav-item nav-link"><i class="fa fa-comment me-2"></i>Chat</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-sm-6 col-xl-3">
                        <div class=" rounded d-flex align-items-center justify-content-between p-4"style="background-color: #4169e1;">
