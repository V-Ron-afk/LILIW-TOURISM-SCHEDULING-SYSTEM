...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex "style="color: #fff;">Naven</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
            ...
            <!-- Table Start -->
            <a style="margin-left:1000px;" href="calendar.php"><i class="fa fa-calendar" aria-hidden="true"></i></a>
            <?php 

            $sqlget ="SELECT * FROM schedule 
            INNER JOIN users ON schedule.username = users.username";
