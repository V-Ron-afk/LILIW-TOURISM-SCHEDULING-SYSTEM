    ...
    <div class="container-fluid position-relative d-flex p-0">
         ...
         <div class="sidebar pe-4 pb-3">
            <nav class="navbar ">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="#" class="nav-item nav-link"><i class="fa fa-address-book me-2"></i>Archives</a>
                    <a href="#" class="nav-item nav-link"><i class="fa fa-address-book me-2"></i>History schedule</a>
        ...
        <div class="content">
            ...
            <!-- Table Start -->
                            ...
                            echo "<table style='width: 50%; margin-top:5%; margin-left: 5%;' class='table table-hover'>";
